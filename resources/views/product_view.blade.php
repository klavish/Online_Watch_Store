                    ...
                    <div class="col-md-6">
                        ...
                        @else  
                             ...
                             <h6>{{ 'For: ' . $product->gender }}</h6>
                               <h6>{{ 'Function: ' . $product->function }}</h6>
                        </div>
                        ...
                        <div class="d-flex">
                            ...
                            <input class="form-control text-center me-3" name="quantity" id="inputQuantity" type="number" min="1" value="1" style="max-width: 3rem" />
                   ...
                   <div class="card h-100">
                       ...
                       <div class="card-body p-4">
                           <div class="text-center">
                               ...
                               <span class="text-muted text-decoration-line-through">{{ '$' . $relatedProduct->price }}</span>
                       ...
                       <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                           <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="{{ route('product_info', ['product' =>$relatedProduct->product_code] )}}">View Product</a></div>
                       </div>
                   </div>
               </div>
               @endforeach
